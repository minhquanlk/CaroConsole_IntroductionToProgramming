...
void MainCaro()
{
	...
	Sleep(DELAY);
	gotoxy(mid, 8);
	kVe(2), Ve(3), kVe(7), Ve(2), kVe(3);// , Ve(3), kVe(3), Ve(1), kVe(2), Ve(3);
	cout << endl;
	Sleep(DELAY);
	gotoxy(mid, 9);
	kVe(1), Ve(3), kVe(14), Ve(5), kVe(1), Ve(2), kVe(2), Ve(6), kVe(5), Ve(5);// , kVe(3), Ve(1);
	cout << endl;
	Sleep(DELAY);
	gotoxy(mid, 10);
...
void Board(int dai, int rong, int x, int y)
{
	SetColor(8 * 16 + 8);
